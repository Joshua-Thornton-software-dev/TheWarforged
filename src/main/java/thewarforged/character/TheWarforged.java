package thewarforged.character;
...
import static thewarforged.TheWarforgedMod.characterPath;
...
public class TheWarforged extends CustomPlayer {
    ...
    //Strings
    private static final String ID = makeID("Warforged"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass WARFORGED;
        @SpireEnum(name = "WARFORGED_STEEL_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "WARFORGED_STEEL_COLOR") @SuppressWarnings("unused")
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new TheWarforged(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
    ...
    public TheWarforged() {
        super(getNames()[0], Meta.WARFORGED,
