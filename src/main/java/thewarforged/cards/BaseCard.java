...
import thewarforged.TheWarforgedMod;
import thewarforged.util.CardStats;
import thewarforged.util.TriFunction;
...
public abstract class BaseCard extends CustomCard {
    ...
    protected static String makeID(String name) { return TheWarforgedMod.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    TheWarforgedMod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
